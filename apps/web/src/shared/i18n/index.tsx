...
const zhMessages = {
  ...
  videoDeleteRunningDisabled: "进行中的视频任务不能删除。",
  ...
  providerVideoCardHint: "视频配置和生图、Agent 放在同一个配置入口；.env 显式配置时优先生效。",
...
const enMessages: I18nMessages = {
  ...
  videoDeleteRunningDisabled: "Running video tasks cannot be deleted.",
  ...
  providerVideoCardHint: "Video settings live beside image and Agent settings. Explicit .env settings still take priority.",
