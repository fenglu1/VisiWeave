...
const zhMessages = {
  ...
  requestLogBody: "请求体",
  requestLogCategoryAgent: "Agent",
  requestLogCategoryAll: "全部分类",
  requestLogCategoryImageToImage: "图生图",
  requestLogCategoryImageToVideo: "图生视频",
  requestLogCategoryLabel: "分类",
  requestLogCategoryTextToImage: "文生图",
  requestLogCategoryTextToVideo: "文生视频",
  requestLogCollapse: "合并",
  requestLogCopied: "已复制",
  requestLogCopy: "复制",
  requestLogCreatedAt: "时间",
  requestLogDuration: "耗时",
  requestLogExpand: "展开",
  requestLogHeaders: "请求头",
  requestLogProvider: "服务",
  requestLogResponse: "响应",
  requestLogsDeck: ({ hours }: { hours: number }) => `只展示最近 ${hours} 小时内开启日志后产生的请求记录，密钥和图片数据已脱敏。`,
  requestLogsEmpty: "当前筛选下暂无请求记录",
  requestLogsEyebrow: "Provider Request Log",
  requestLogsFilters: "请求日志筛选",
  requestLogsList: "请求日志列表",
  requestLogsLoadFailed: "请求日志加载失败。",
  requestLogsLoading: "正在加载请求日志...",
  requestLogsOpen: "双击打开请求日志",
  requestLogsRequestFailed: ({ status }: { status: number }) => `请求日志接口失败，状态 ${status}。`,
  requestLogsRetention: "日志保留时间",
  requestLogsRetentionValue: ({ hours }: { hours: number }) => `保留 ${hours} 小时`,
  requestLogsSelectEmpty: "选择一条记录查看详情",
  requestLogsTitle: "请求日志",
  requestLogServiceAgent: "Agent",
  requestLogServiceAll: "全部服务",
  requestLogServiceImage: "生图",
  requestLogServiceLabel: "服务",
  requestLogServiceVideo: "视频",
  requestLogStatusError: "错误",
  requestLogUrl: "请求路径",
  ...
  providerImageAdapterEnable: "启用",
  providerImageAdapterEnabled: ({ provider }: { provider: string }) => `已启用${provider}。`,
  providerImageAdapterInUse: "使用中",
  providerImageAdapterKind: "生图适配器",
  providerImageFormat: "生图格式",
  providerImageFormatGemini: "Gemini generateContent",
  providerImageFormatNewApi: "NewAPI",
  providerImageFormatSub2Api: "Sub2API",
  providerImageModelsEmpty: "Gemini relay returned no image-capable models.",
  providerRequestLoggingAgent: "开启 Agent 请求日志（保留 6 小时）",
  providerRequestLoggingImage: "开启生图请求日志（保留 6 小时）",
  providerRequestLoggingVideo: "开启视频请求日志（保留 6 小时）",
...
const enMessages: I18nMessages = {
  ...
  navVideoLibrary: "Video Library",
  requestLogBody: "Request body",
  requestLogCategoryAgent: "Agent",
  requestLogCategoryAll: "All categories",
  requestLogCategoryImageToImage: "Image to Image",
  requestLogCategoryImageToVideo: "Image to Video",
  requestLogCategoryLabel: "Category",
  requestLogCategoryTextToImage: "Text to Image",
  requestLogCategoryTextToVideo: "Text to Video",
  requestLogCollapse: "Collapse",
  requestLogCopied: "Copied",
  requestLogCopy: "Copy",
  requestLogCreatedAt: "Created",
  requestLogDuration: "Duration",
  requestLogExpand: "Expand",
  requestLogHeaders: "Headers",
  requestLogProvider: "Provider",
  requestLogResponse: "Response",
  requestLogsDeck: ({ hours }) => `Shows requests recorded in the last ${hours} hours after logging was enabled. Keys and image data are redacted.`,
  requestLogsEmpty: "No request logs match this filter",
  requestLogsEyebrow: "Provider Request Log",
  requestLogsFilters: "Request log filters",
  requestLogsList: "Request log list",
  requestLogsLoadFailed: "Request logs failed to load.",
  requestLogsLoading: "Loading request logs...",
  requestLogsOpen: "Double-click to open request logs",
  requestLogsRequestFailed: ({ status }) => `Request log request failed with status ${status}.`,
  requestLogsRetention: "Log retention",
  requestLogsRetentionValue: ({ hours }) => `${hours} hour retention`,
  requestLogsSelectEmpty: "Select a record to inspect it",
  requestLogsTitle: "Request Logs",
  requestLogServiceAgent: "Agent",
  requestLogServiceAll: "All services",
  requestLogServiceImage: "Image",
  requestLogServiceLabel: "Service",
  requestLogServiceVideo: "Video",
  requestLogStatusError: "Error",
  requestLogUrl: "Request URL",
  ...
  providerImageAdapterEnable: "Enable",
  providerImageAdapterEnabled: ({ provider }) => `${provider} is now enabled.`,
  providerImageAdapterInUse: "In use",
  providerImageAdapterKind: "Image adapter",
  providerImageFormat: "Image format",
  providerImageFormatGemini: "Gemini generateContent",
  providerImageFormatNewApi: "NewAPI",
  providerImageFormatSub2Api: "Sub2API",
  providerImageModelsEmpty: "The Gemini relay did not return any image-capable models.",
  providerRequestLoggingAgent: "Log Agent requests for 6 hours",
  providerRequestLoggingImage: "Log image requests for 6 hours",
  providerRequestLoggingVideo: "Log video requests for 6 hours",
  providerLocalApiKeyPlaceholder: "API key",
